...
numactl --cpunodebind=netdev:usrp0 --membind=netdev:usrp0 ./nr-uesoftmodem --ue-fo-compensation --sa --uicc0.imsi 20899000074$imsi_string --usrp-args "addr=192.168.40.2" -E --numerology 1 -r 106 --band 78 -C 3619200000 --nokrnmod 1 --ue-txgain 0 -A 2539 --clock-source 1 --time-source 1 2>&1 | tee ../../../../mylogs/UE1-$(date +"%m%d%H%M").log | tee /root/last_log
